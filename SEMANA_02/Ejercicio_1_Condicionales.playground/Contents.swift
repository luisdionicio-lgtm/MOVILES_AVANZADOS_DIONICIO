...
if temperatura > 30 {
    print("Hace calor")
} else if temperatura > 20 { // FIX 1: faltaba la llave de apertura.
...
let saldo = 100.0
let compra = 150.0
if saldo >= compra { // FIX 2: el saldo puede ser igual al costo de la compra.
    print("Compra realizada")
} else {
    // FIX 3: para obtener un monto positivo, se resta el saldo a la compra.
...
// No imprime "Mayor que 5" porque, al cumplirse y > 10, Swift ejecuta ese
// bloque y omite las condiciones restantes de la misma cadena.
